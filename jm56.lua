...
local UITab71 = win:Tab("『剑斗士模拟器』",'7734068321')

local about = UITab71:section("『剑斗士模拟器』",true)

about:Button("剑斗士模拟器1",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/bebedi15/DisticHub/main/Loader.lua"))()
end)

local UITab72 = win:Tab("『军事大亨』",'7734068321')

local about = UITab72:section("『军事大亨』",true)
